...
import (
	...
	"github.com/getbread/go-git/v5/plumbing/format/packfile"
	"github.com/getbread/go-git/v5/plumbing/object"
	"github.com/getbread/go-git/v5/plumbing/protocol/packp"
	"github.com/getbread/go-git/v5/plumbing/protocol/packp/capability"
	"github.com/getbread/go-git/v5/plumbing/protocol/packp/sideband"
	"github.com/getbread/go-git/v5/plumbing/revlist"
	"github.com/getbread/go-git/v5/plumbing/storer"
	"github.com/getbread/go-git/v5/plumbing/transport"
	"github.com/getbread/go-git/v5/plumbing/transport/client"
	"github.com/getbread/go-git/v5/storage"
